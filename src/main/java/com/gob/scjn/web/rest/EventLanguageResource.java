...
public class EventLanguageResource {
     ...
     *
     * @param eventLanguageDTO the eventLanguageDTO to create
     * @return the ResponseEntity with status 201 (Created) and with body the new eventLanguageDTO, or with status 400 (Bad Request) if the eventLanguage has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/event-languages")
    @Timed
    public ResponseEntity<EventLanguageDTO> createEventLanguage(@RequestBody EventLanguageDTO eventLanguageDTO) throws URISyntaxException {
        log.debug("REST request to save EventLanguage : {}", eventLanguageDTO);
        if (eventLanguageDTO.getId() != null) {
            throw new BadRequestAlertException("A new eventLanguage cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     *
     * @param eventLanguageDTO the eventLanguageDTO to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated eventLanguageDTO,
     * or with status 400 (Bad Request) if the eventLanguageDTO is not valid,
     * or with status 500 (Internal Server Error) if the eventLanguageDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/event-languages")
    @Timed
    public ResponseEntity<EventLanguageDTO> updateEventLanguage(@RequestBody EventLanguageDTO eventLanguageDTO) throws URISyntaxException {
     ...
     *
     * @param id the id of the eventLanguageDTO to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the eventLanguageDTO, or with status 404 (Not Found)
     */
     ...
     *
     * @param id the id of the eventLanguageDTO to delete
